...
<div class="gw-box-frame-top">
    <div class="gw-box-header">
        <div class="gw-box-row">
            <asp:Label ID="tableLabel" runat="server" Text="Global parameters" Width="180px" />
        </div>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td style="width: auto; vertical-align: top">
                        <table class="FormTable" style="width: 100%">
                            ...
                            <tr>
                                <td class="FormField">
                                    <div class="FormField" style="width: 100%; height:122px">
                                        <asp:CheckBoxList ID="xmatchColumnList" runat="server"
                                            RepeatLayout="UnorderedList"
                                            RepeatDirection="Vertical" CssClass="FormField" Height="120px" />
                                    </div>
                                </td>
                            </tr>
                        </table>

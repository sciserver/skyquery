...
{
    [TestClass]
    public class MyDBSqlQueryTest : SkyQueryTestBase
    {
        [ClassInitialize]
        ...
        public void MyDBTableQueryTest()
        {
            ...
            {
                DropUserDatabaseTable("MyDBSqlQueryTest_MyDBTableQueryTest");
        ...
        public void MyDBTableJoinedQueryTest1()
        {
            using (SchedulerTester.Instance.GetToken())
            {
                DropUserDatabaseTable("MyDBSqlQueryTest_MyDBTableJoinedQueryTest1");
...
INNER JOIN MYDB:MySDSSSample b ON a.ObjID = b.objID";
        ...
        public void MyDBTableJoinedQueryTest2()
        {
            using (SchedulerTester.Instance.GetToken())
            {
                DropUserDatabaseTable("MyDBSqlQueryTest_MyDBTableJoinedQueryTest2");
...
INNER JOIN MYDB:MySDSSSample b ON a.ObjID = b.ObjID";
        ...
        public void SelfJoinQueryTest()
        {
            using (SchedulerTester.Instance.GetToken())
            {
                DropUserDatabaseTable("MyDBSqlQueryTest_SelfJoinQueryTest");
...
CROSS JOIN MyCatalog b";
        ...
        public void SelfJoinQueryTest2()
        {
            using (SchedulerTester.Instance.GetToken())
            {
                DropUserDatabaseTable("MyDBSqlQueryTest_SelfJoinQueryTest2");
